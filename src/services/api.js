...
let mockRisks = [
  {
    ...
    description: 'Potential exposure of customer PII via misconfigured systems.',
    status: 'Active',
    priority: 'High',
    date: '2026-04-10',
  ...
  },
  {
    ...
    description: 'Weak IAM controls could allow privilege escalation.',
    status: 'In Progress',
    priority: 'Medium',
    date: '2026-03-18',
  ...
  },
  {
    id: 'r3',
    name: 'Service outage',
    description: 'Third-party dependency failures may impact availability.',
    status: 'Open',
    priority: 'Low',
    date: '2026-02-08',
    createdAt: '2026-02-08T12:15:00.000Z',
  },
  {
    id: 'r4',
    name: 'Compliance gaps',
    description: 'Missing audit evidence for recurring processes.',
    status: 'Closed',
    priority: 'High',
    date: '2026-01-20',
  ...
  {
    id: 'r5',
    name: 'Invoice processing errors',
    description: 'Incorrect billing rules leading to financial inconsistencies.',
    status: 'Active',
    priority: 'High',
    date: '2025-12-11',
